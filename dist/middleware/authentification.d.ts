export declare const checkoutEmail: (email: string) => boolean;
export declare const checkoutUsername: (username: string) => boolean;
export declare const checkoutPassword: (password: string) => boolean;
